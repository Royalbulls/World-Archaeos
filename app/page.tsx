...
import type { VirtualToolConfig } from '@/components/VirtualTool';
...
const ArtifactAnalyzer = dynamic(() => import('@/components/ArtifactAnalyzer'), { ssr: false });
const MysterySolver = dynamic(() => import('@/components/MysterySolver'), { ssr: false });
const LanguageTranslator = dynamic(() => import('@/components/LanguageTranslator'), { ssr: false });
const ResourceMapper = dynamic(() => import('@/components/ResourceMapper'), { ssr: false });
const DiscoveriesFeed = dynamic(() => import('@/components/DiscoveriesFeed'), { ssr: false });
const BotanicalLab = dynamic(() => import('@/components/BotanicalLab'), { ssr: false });
const GeologicalAnalyzer = dynamic(() => import('@/components/GeologicalAnalyzer'), { ssr: false });
const TemporalReconstructor = dynamic(() => import('@/components/TemporalReconstructor'), { ssr: false });
const VastuArchitect = dynamic(() => import('@/components/VastuArchitect'), { ssr: false });
const AIAgentCreator = dynamic(() => import('@/components/AIAgentCreator'), { ssr: false });
const MysticOracle = dynamic(() => import('@/components/MysticOracle'), { ssr: false });
const VedicTechLab = dynamic(() => import('@/components/VedicTechLab'), { ssr: false });
const AkashicExplorer = dynamic(() => import('@/components/AkashicExplorer'), { ssr: false });
const AncientSoundLab = dynamic(() => import('@/components/AncientSoundLab'), { ssr: false });
const BioMachineAnalyzer = dynamic(() => import('@/components/BioMachineAnalyzer'), { ssr: false });
const KilvishBabaApp = dynamic(() => import('@/components/KilvishBabaApp'), { ssr: false });
const DestinyNavigator = dynamic(() => import('@/components/DestinyNavigator'), { ssr: false });
const ArchaeosPublisher = dynamic(() => import('@/components/ArchaeosPublisher'), { ssr: false });
const ArchaeosFinder = dynamic(() => import('@/components/ArchaeosFinder'), { ssr: false });
const EvolutionCore = dynamic(() => import('@/components/EvolutionCore'), { ssr: false });
const AIKathaVachak = dynamic(() => import('@/components/AIKathaVachak'), { ssr: false });
const DailyPulse = dynamic(() => import('@/components/DailyPulse'), { ssr: false });
const WorldArchaeosTrust = dynamic(() => import('@/components/WorldArchaeosTrust'), { ssr: false });
const HomeView = dynamic(() => import('@/components/HomeView'), { ssr: false });
const Settings = dynamic(() => import('@/components/Settings'), { ssr: false });
const Namkaran = dynamic(() => import('@/components/Namkaran'), { ssr: false });
const LegacyArchitect = dynamic(() => import('@/components/LegacyArchitect'), { ssr: false });
const SanskarHub = dynamic(() => import('@/components/SanskarHub'), { ssr: false });
const ProfessionalServices = dynamic(() => import('@/components/ProfessionalServices'), { ssr: false });
const DharmaStrategist = dynamic(() => import('@/components/DharmaStrategist'), { ssr: false });
const NajarNivaran = dynamic(() => import('@/components/NajarNivaran'), { ssr: false });
const AIInfluencerStudio = dynamic(() => import('@/components/AIInfluencerStudio'), { ssr: false });
const Reconstructor = dynamic(() => import('@/components/Reconstructor'), { ssr: false });
const UserProfile = dynamic(() => import('@/components/UserProfile'), { ssr: false });
const UserMenu = dynamic(() => import('@/components/UserMenu'), { ssr: false });
const ArtifactDiscovery = dynamic(() => import('@/components/ArtifactDiscovery'), { ssr: false });
const KundliGenerator = dynamic(() => import('@/components/KundliGenerator'), { ssr: false });
const PitchDeck = dynamic(() => import('@/components/PitchDeck'), { ssr: false });
const VedicLibrary = dynamic(() => import('@/components/VedicLibrary'), { ssr: false });
const SatelliteAnalyzer = dynamic(() => import('@/components/SatelliteAnalyzer'), { ssr: false });
const VirtualTool = dynamic(() => import('@/components/VirtualTool'), { ssr: false });
const AppBlueprintGenerator = dynamic(() => import('@/components/AppBlueprintGenerator'), { ssr: false });
const SoulCouncil = dynamic(() => import('@/components/SoulCouncil'), { ssr: false });
const SoulJourneyBook = dynamic(() => import('@/components/SoulJourneyBook'), { ssr: false });
